// Brand glyphs. lucide-react dropped its brand icons, so the real marks live
...
function Glyph({
  ...
  title,
  d,
}: SocialIconProps & { title: string; d: string }) {
  return (
    <svg
      role="img"
      aria-hidden
...
export const WhatsAppIcon  = (p: SocialIconProps) => <Glyph {...p} title="WhatsApp"  d={WHATSAPP_PATH} />
export const InstagramIcon = (p: SocialIconProps) => <Glyph {...p} title="Instagram" d={INSTAGRAM_PATH} />
export const FacebookIcon  = (p: SocialIconProps) => <Glyph {...p} title="Facebook"  d={FACEBOOK_PATH} />
